			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="row">
						...
						<div class="col-sm-4">
							<button type="button" class="btnA btn btn-lg btn-block btn-primary"><a style="color: white;" href="https://github.com/xiao5Emma" target="_blank">github</a></button>
						</div>
						<div class="col-sm-4">
...
{{--                    圆形--}}
                ...
                <div class="row" style="margin-top: 1em">
                    ...
                    <div class="col-sm-2">
                        ...
                        <ul class="techList  float-left techListLi2" >
                            <li>php7</li>
                            <li>Redis</li>
                            <li>Mysql8</li>
                            <li>Workerman3.5</li>
        ...
        <div class="row" id="index_introdution" style="background-color:white;padding: 35px 0 35px 0">
            ...
            <p class="col-sm-10 text-center" style="font-size: 1.2em; font-weight: 200;margin-bottom: 4em;">
                伍晓莹, 90后程序员。现居广州, 主要专注 PHP 开发, 目前工作{{  ceil(date('Y', strtotime(now()))-2017)  }}年<br>
                开发过MES管理后台, 对 Centos7 和 树莓派 比较了解。
                曾经独立完成纯前端项目 , 对 Vue 以及一些前端技术也有一定的了解 <br>热衷于关注互联网技术, 每天实现自我提升<br>
