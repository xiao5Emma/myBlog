...
@section('content')
    <div class="container-fluid topPosition">
        <div class="row " style="min-height:44em;background-color: #f8f8f8;overflow-y: scroll" >
                <div class="col-sm-1">
                    <div class="row" style="position:fixed;top:13em;left: 2em;" ><button onclick="like()" class="btnA btn btn-xs btn-primary cycleBtn">like</button></div>
                    <div class="row" style="position:fixed;top:19em;left: 2em;"><button onclick="share({{$article->id}})" class="btnB btn btn-xs btn-success cycleBtn">share</button></div>
                </div>
